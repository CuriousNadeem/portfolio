document.addEventListener("DOMContentLoaded", function () {
  let containers = document.querySelectorAll(".image-sequence2"); // Get all image-sequence containers
  ...
  if (containers) {
    containers.forEach((container, index) => {
      const frames = Array.from(container.getElementsByClassName("frame2"));
